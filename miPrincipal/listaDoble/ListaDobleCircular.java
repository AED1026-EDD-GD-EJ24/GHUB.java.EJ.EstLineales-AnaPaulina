...
public class ListaDobleCircular <T>{
    ...
    public void agregar(T valor){
        ...
        if (esVacia()){
            cabeza = nuevo; 
            //enlazar anterior y siguiente consigo mismo
    ...
    public void insertar(T valor, int pos) throws PosicionIlegalException{
        if(pos>=0 && pos<=tamanio){
            ...
            if(pos==0){
                ...
                cabeza.setAnterior(nuevo);
                cabeza = nuevo;
                //enlazar elprimero con el ultimo y ultimocon primero
                nuevo.setAnterior(ultimo);
                ...
                if(pos==tamanio){
                    Nodo<T> ultimo=cabeza.getAnterior();
                    ultimo.setSiguiente(nuevo);
                    //enlazar primero con el ultimo yultimocon primero
                    nuevo.setSiguiente(cabeza);
                    cabeza.setAnterior(nuevo);
                }
                else{
    ...
    public void remover (int pos) throws PosicionIlegalException{
        if(pos>=0 && pos<tamanio){
            if (pos==0){
                ...
                //enlazar el primero con ultimo y ultimo con primero 
